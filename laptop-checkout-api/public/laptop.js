class Laptop {
    ...
    static addLaptop(laptop) {
        ...
        var laptopListItem = $('<li class="laptop"><text><strong>Laptop:</strong> ' 
            + laptop.name + ' <strong>Serial Code:</strong> ' 
            + laptop.serialCode + '</text><span>X</span></li>');
    ...
    static createLaptop() {
        ...
        var laptopCodeInput = $('#laptopCodeInput').val();
        // Clear input
        $('#laptopNameInput').val('');
        $('#laptopCodeInput').val('');

        $.post('/api/laptops', {name: laptopNameInput, serialCode: laptopCodeInput})
